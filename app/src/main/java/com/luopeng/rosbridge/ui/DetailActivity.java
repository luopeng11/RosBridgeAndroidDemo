...
import com.jilk.ros.entity.PublishEvent;
...
public class DetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubTopic.setOnClickListener(this::onClick);
        ...
        if (detailName.equals("/cmd_vel") || detailName.equals("/smooth_cmd_vel")) {
            processMoveTopic(detailName);
        }
    }
    ...
    private void processMoveTopic(String detailName) {
        timer = new Timer();
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                if (moving) {
                    client.send("{\"op\":\"publish\",\"topic\":\"" + detailName + "\",\"msg\":{\"linear\":{\"x\":" + linearX + ",\"y\":0,\"z\":0},\"angular\":{\"x\":0,\"y\":0,\"z\":" + angularZ + "}}}");
                ...
                switch (motionEvent.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if (Math.abs(x - startX) > Math.abs(y - startY)) {
                            angularZ = x-startX<0?0.1f:-0.1f;//Max 0.2
                            linearX = 0f;//Max 0.2
                        } else {
                            linearX = y - startY < 0 ? 0.1f : -0.1f;//Max 0.2
                            angularZ=0f;
                        }
